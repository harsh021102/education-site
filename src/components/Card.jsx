...
const Card = ({image,heading,content}) => {
  return (
    <div data-aos="fade-down" className='flex flex-col border-2 border-lightpurple rounded-xl shadow-md'>
        ...
        <h1 className='text-2xl text-transparent bg-clip-text bg-gradient-to-b from-cyan-300 to-purplish mt-4 w-full font-bold md:text-xl lg:text-3xl pl-4'>{heading}</h1>
